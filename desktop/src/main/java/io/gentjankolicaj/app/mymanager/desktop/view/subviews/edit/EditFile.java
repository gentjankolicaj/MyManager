...
public class EditFile extends JDialog {
	...
	private void initComponents() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(EditFile.class.getResource("/io/gentjankolicaj/apps/mymanager/resources/icons/icons_24x24/icons8-edit-file-3.png")));
