 ...
 */
public class UserContact extends MyModel {
     ...
     * @param updatedDate
     */
    public UserContact(int contactId, String personId, int telephone, int celular, String email, String fax,
    ...
    public String toString() {
        return "UserContact [contactId=" + contactId + ", personId=" + personId + ", telephone=" + telephone
