...
public class Department extends MyModel {
     ...
     * @param updatedDate
     */
    public Department(int departmentId, String departmentName, String managerId, String createdBy, String updatedBy,
    ...
    public String toString() {
        return "Department [departmentId=" + departmentId + ", departmentName=" + departmentName + ", managerId="
                + managerId + ", createdBy=" + createdBy + ", updatedBy=" + updatedBy + ", createdDate=" + createdDate
