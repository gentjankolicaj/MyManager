...
import io.gentjankolicaj.app.mymanager.desktop.db.migration.LiquibaseMigrator;
...
public class GenericDatabase extends Database {
    ...
    public ResultSet selectStatement(String query, List<Object> list) throws SQLException {
        ...
        PreparedStatement preparedStatement = HikariConnectionPoolManager.getConnection().prepareStatement(query);
