...
import io.gentjankolicaj.app.mymanager.desktop.data.dao.UserAdressDao;
import io.gentjankolicaj.app.mymanager.desktop.data.models.Country;
import io.gentjankolicaj.app.mymanager.desktop.data.models.UserAdress;
...
public class UserAdressDaoImpl implements UserAdressDao {
     ...
     * @param queryType
     */
    public UserAdressDaoImpl(QueryType queryType) {
        super();
    ...
    @Override
	public List<UserAdress> findAllAdresses() throws Exception {
	...
	@Override
	public List<UserAdress> findAllAdresses(int limit, int offset) throws Exception {
		List<UserAdress> adressList = new ArrayList<>();
		ResultSet results = null;
		String query = null;
	...
	@Override
	public UserAdress findAdressesByPersonId(String personId) throws Exception {
	...
	@Override
	public List<UserAdress> findAdressesByCity(String city) throws Exception {
		List<UserAdress> adressList = new ArrayList<>();
		ResultSet results = null;
		String query = null;
	...
	@Override
	public List<UserAdress> findAdressesByCountry(String country) throws Exception {
		List<UserAdress> adressList = new ArrayList<>();
		ResultSet results = null;
		String query = null;
	...
	@Override
	public List<UserAdress> findAdressesByStreet(String streetName) throws Exception {
		List<UserAdress> adressList = new ArrayList<>();
		ResultSet results = null;
		String query = null;
	...
	@Override
	public UserAdress findAdress(int adressId) throws Exception {
		UserAdress adress = null;
		ResultSet results = null;
	...
	public int updateAdress(UserAdress oldAdress, UserAdress newAdress) throws Exception {
		String 	query = "UPDATE mymanager.user_adress SET user_id=?,country=?,city=?,street_name=?,zipcode=?,building=?,created_by=?,created_date=?,updated_by=?,updated_date=? WHERE adress_id=?";
		
		setQueryType(QueryType.NORMAL);
		
		UserAdress temp = findAdress(oldAdress.getAdressId());
