...
import io.gentjankolicaj.app.mymanager.desktop.view.subviews.*;
import io.gentjankolicaj.app.mymanager.desktop.view.subviews.custom.MyPanel;
import io.gentjankolicaj.app.mymanager.desktop.view.subviews.employee.EmployeeDataView;
import io.gentjankolicaj.app.mymanager.desktop.view.subviews.user.UserDataView;
		...
		rightsPanel.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				if (user.getUserType().equals(UserType.ADMIN.toString())) {
					...
					WindowUtils.showMessage(null, "Admin users only can access rights panel.", MessageType.INFORMATION);
		...
		countryPanel.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				if (user.getUserType().equals(UserType.ADMIN.toString())) {
					...
					WindowUtils.showMessage(null, "Admin users only can access country panel.", MessageType.INFORMATION);
            }
        });
