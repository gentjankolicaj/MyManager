 ...
 *
 */
public class EmployeeAdressAcessObject implements EmployeeAdressAccess {
	 ...
	 * @param queryType
	 */
	public EmployeeAdressAcessObject(QueryType queryType) {
		super();
	...
	public EmployeeAdressAcessObject() {
		super();
	...
	public List<EmployeeAdress> findAllAdresses() throws Exception {
		...
		String query = null;
			...
			while (results.next()) {
				EmployeeAdress temp = new EmployeeAdress(results.getInt("adress_id"), results.getString("employee_id"),
