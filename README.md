...
MyManager is application for managing employees & users using GUI & MySQL.Note that this is just a prototype,IS NOT
...
<br>2. From parent directory type : docker compose up -d , this step should download images & setup containers.Also db
